...
V4 adds independently mounted pathname scopes, prefix-aware generated types, `PrefixLink`, `prefixHref()`, `useActivityPrefix()`, `usePageParams()`, project-root `@/` imports, listener-first compiler recovery, a PAGE/HTTP/SOCKET/EMBED route table, and a redesigned development diagnostics surface. Ludicord 4.0.1 fixes Discord iframe navigation and keeps the runtime Discord application ID consistent across the client, HTTP, authentication, and WebSockets. Read the [V4 Prefix Router guide](https://github.com/mrcholer/ludicord/blob/main/docs/prefix-router.md), [migration guide](https://github.com/mrcholer/ludicord/blob/main/docs/migration-v4.md), and [4.0.1 release notes](https://github.com/mrcholer/ludicord/blob/main/releases/v4/4.0.1.md).
