...
- [Discord SDK](discord-sdk.md)
- [Login and sessions](login.md)
- [Environment Variables](environment-variables.md)
- [Discord Developer Portal Setup](discord-developer-portal.md)

## Server features

- [API Routes](api-routes.md)
- [WebSockets](websockets.md)
- [Activity Rooms](activity-rooms.md)
- [Participants](participants.md)
- [Voice Events](voice-events.md)
- [Mobile and Layout](mobile-layout.md)

## Production and operations

- [Development, hot updates, and error panel](development.md)
- [Build](build.md)
- [Start](start.md)
...
- [Machine-readable type compatibility records](../types/README.md)
